...
import com.zhoubi.graindepot.config.druid.JdbcTypeInterceptor;
...
public class MybatisConfiguration implements EnvironmentAware {
    ...
    public DataSource druidDataSource() {
        ...
        druidDataSource.setValidationQuery(StringUtils.isNotBlank(validationQuery) ? validationQuery : "select 1");
    ...
    public SqlSessionFactory sqlSessionFactoryBean(DataSource dataSource) {
        ...
        JdbcTypeInterceptor jti=new JdbcTypeInterceptor();
        Properties properties1 = new Properties();
        properties1.setProperty("jdbcTypeForNull","NULL");
        jti.setProperties(properties1);
        //分页插件
        ...
        Interceptor[] plugins =  new Interceptor[]{pageHelper,jti};
